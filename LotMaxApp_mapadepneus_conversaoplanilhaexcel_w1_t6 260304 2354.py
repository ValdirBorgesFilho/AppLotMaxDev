...
versao_app="w1.5a"                 # Arquivo de origem - LotMaxApp_mapadepneus_conversaoplanilhaexcel_w1_t5 260304 0011.py
...
# 4a. CHAME A FUNÇÃO logo após o seu bloco de CSS principal
estilo_idioma_uploader()
